...
<meta name="description" content="Exibe o resultado do rastro de um único objeto." />
<meta name="keywords" content="rastreamento" />
...
<script>if(!RVBD_EUE_PARAM){var RVBD_EUE_PARAM={};} RVBD_EUE_PARAM.pageId = 'a2_4334b384-d4b0-43e4-87f6-764b5fe4ae44';</script>             
<!-- AppInternalsXpert BMX Integration End -->
<script type="text/javascript"> 
pageid = '0D0240A5-DEC2-05A1-000FDE7214B214BB'; 
</script>
<noscript>
...
<ul>
  ...
  <li><a href="https://www.correios.com.br/enviar-e-receber/precisa-de-ajuda/como-rastrear-um-objeto" target="_self" >Como rastrear um objeto</a></li>
  <li><a href="https://www.correios.com.br/enviar-e-receber/precisa-de-ajuda/siglas-utilizadas-no-rastreamento-de-objeto" target="_self" >Siglas utilizadas no rastreamento de objetos</a></li>
...
<h3><span class="codSro"><span>NX</span><span>009</span><span>248</span><span>775</span><span>BR</span></h3>
</div>
<div class="msg">
...
<p>O prazo estimado de entrega dos objetos registrados &eacute; de 40 DIAS &Uacute;TEIS a partir da confirma&ccedil;&atilde;o de pagamento dos impostos (se tributado) e do despacho postal. <a href="https://www.correios.com.br/enviar-e-receber/importacao/precos-e-prazos" target="_blank">Tabela prazos de entrega</a></p>
...
<!-- pode ser suspenso: NX009248775BR-true-->
<div class="highlightSRO">

<!-- imagem: entrega_transito_1.gif -->
...
<tr>
<td class="sroDtEvent" valign="top">04/08/2020 <br />
18:07       <br />
BELEM / PA<br />
...
<tr>
<td class="sroDtEvent" valign="top">30/07/2020 <br />
13:49       <br />

<label style="text-transform:capitalize;">BELEM&nbsp;/&nbsp;PA</label>

</td>
<td class="sroLbEvent">

<strong>Objeto ainda não chegou à unidade</strong>
 <br />
Por favor, aguarde 	
</td>
</tr>
...
<tr>
<td class="sroDtEvent" valign="top">20/07/2020 <br />
08:18       <br />
CAJAMAR / SP<br />
...
<tr>
<td class="sroDtEvent" valign="top">18/07/2020 <br />
07:31       <br />
CURITIBA / PR<br />
...
<label style="text-transform:capitalize;">CURITIBA&nbsp;/&nbsp;PR</label>

</td>
<td class="sroLbEvent">

<strong>Fiscalização aduaneira finalizada</strong>
 <br />
...
<tr>
<td class="sroDtEvent" valign="top">17/07/2020 <br />
13:28       <br />
...
<strong>Objeto recebido pelos Correios do Brasil</strong>
 <br />
...
<tr>
<td class="sroDtEvent" valign="top">16/07/2020 <br />
12:06       <br />

<label style="text-transform:capitalize;">CHINA&nbsp;/&nbsp;</label>
...
<img src="home2014/img/SRO/entrega_transito_1.gif" alt="Objeto encaminhado">

</div>
<br />
<div id="datas">
<div id="EventoPostagem" style="float:left;width:33%">

<strong>Postagem</strong><br />
16/07/2020 	  
</div>

<div id="UltimoEvento" style="float:left;width:33%;">
<strong>Objeto encaminhado</strong><br />
04/08/2020 
</div>
<div id="DataEntrega" style="float:right;width:33%">
...
<input type="hidden" name="objetos" value="NX009248775BR" />
</form>
...
<a class="icon stop sro" onClick="document.getElementById('formTelaSusp').submit();"><img class="stop" width="22px" height="22px" src="home2014/img/trans.gif">Suspender Entrega</a>
<form name="formTelaSusp" id="formTelaSusp" method="post" action="sistemas/rastreamento/suspensaoEntrega/dsp/default.cfm">
<input type="hidden" name="ObjAsuspender" id="ObjAsuspender" value="NX009248775BR" />
</form>

<a class="icon sms sro" id="modalSms"><img width="22px" height="22px" src="home2014/img/trans.gif">Receber por SMS</a> <a href="https://www.correios.com.br/para-voce/precisa-de-ajuda/como-rastrear-um-objeto/rastreamento-via-sms" class="icon sms sro"><img width="22px" height="22px" src="home2014/img/trans.gif">Cancelar/Restabelecer SMS</a>
...
<div  id="qrcodeTable" style="float:left; width:100px"> <img src="https://chart.apis.google.com/chart?cht=qr&chl=NX009248775BR&chs=116x116"
alt="NX009248775BR - QR code"/> </div>
...
<div style="float:left; width:100px; margin:3px;"> <a href="https://apps.apple.com/us/app/correios/id1399617917?l=pt&ls=1" target="_blank"> <img src="home2014/img/sro/Apple-store.png" width="138" height="43" style="border:2px solid #eee"> </a> <a href="https://play.google.com/store/apps/details?id=br.com.correios.preatendimento" target="_blank"> <img src="home2014/img/sro/Google-store.png" width="138" height="43" style="border:2px solid #eee"> </a> </div>
...
<div id="inline_content2" class="inline_content">
    ...
    <h1>Rastreamento</h1>
    <form name="sms" id="formSms" method="post" action="sistemas/rastreamento/resultado.cfm"  onsubmit="return validaFormSms(this);"/>
      <fieldset>
      <div class="form">
        <h2>Receber rastreamento por SMS</h2>
        <label> Celular do remetente:<br />
        <input name="celularum" id="celularum" type="tel"  class="validate[required] text-input f5col">
        <br />
        <span class="">Informe tamb&eacute;m o c&oacute;digo de sua cidade</span> </label>
        <div class="separator"></div>
        <label>Celular do destinatário: <br />
        <input name="celulardois" id="celulardois" type="tel" class="validate[required] text-input f5col">
        <br />
        <span class="">Informe tamb&eacute;m o c&oacute;digo de sua cidade</span> </label>
        <div class="separator"></div>
        <p style="font-size:1.1em; margin-bottom:5px; text-align: justify;"> <strong>Atenção:</strong>O serviço é gratuito, válido apenas para o objeto pesquisado e disponível para SEDEX, SEDEX 10, SEDEX 12, SEDEX Hoje, PAC, Carta Não Comercial Registrada e Carta Comercial Registrada.</p>

            <p>Para deixar de receber SMS dos Correios, envie do seu telefone celular a palavra <strong>SAIR</strong> para o número <strong>28588.</strong></p>

            <p>Para voltar a receber SMS dos Correios, envie do seu telefone celular a palavra  <strong>ENTRAR</strong> para o número <strong>28588.</strong></p><p>** O envio da mensagem é gratuito.</p><br />
        <label>
        <input name="termo" type="checkbox"/>
         Li e concordo com os <a href="sistemas/rastreamento/docs/Termos_e_condicoes_de_uso_do_servico_SMS_dos_Correios.pdf" style="color:##FF0000" target="_blank">termos e condições de uso</a> do recebimento de atualizações por SMS do rastreamento de objetos do Portal Correios. 
		</label>
      </div>
      
      <div class="btnform">
	  
        <input type="hidden" name="etiqueta" value="NX009248775BR" />
	    <input type="hidden" name="objetos" value="NX009248775BR" />
        <input type="submit" id="modalSms" name="botao" value="OK" class="btn1 float-right">
        <input type="button" class="btn2 float-right" value="Cancelar" onclick="$.fn.colorbox.close();">
...
<div class="footer">
  <div class="wrap">
      ...
      <div class="column-footer">
        ...
        <ul>
          <li class="node"><a href="http://apps2.correios.com.br/faleconosco/app/index.php ">Manifestação via Internet</a>
            <ul>
              <li><a href="http://apps2.correios.com.br/faleconosco/app/index.php ">Fale Conosco pelo site</a></li>
            </ul>
          </li>
      ...
      <div class="column-footer">
        ...
        <ul>
          ...
          <li><a href="https://www.correios.com.br/acesso-a-informacao/acoes-e-programas-1/carta-de-servicos-ao-usuario-1/carta-de-servicos-ao-usuario">Carta de servi&ccedil;os ao cidad&atilde;o</a></li>
          <li><a href="http://www.correios.com.br/fale-com-os-correios/denuncia/canal-de-denuncias">Denúncia</a></li>
...
<!-- contentobjects: page generated at 2020-07-28 03:53 PM -->
